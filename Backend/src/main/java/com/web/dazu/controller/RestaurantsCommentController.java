...
import com.web.dazu.service.TipBoardCommentService;

import io.swagger.annotations.ApiOperation;

@CrossOrigin(origins = { "*" }, maxAge = 6000)
@RequestMapping("/tip_board_comment")
@RestController
public class RestaurantsCommentController {
	@Autowired
	private TipBoardCommentService service;
	
	@ApiOperation(value = "팁 게시판 게시글의 댓글목록을 받아온다.", response = List.class)
	...
	@ApiOperation(value = "팁 게시판 게시글 댓글 삭제", response = String.class)
