...
public class KakaoPayAccount {
    ...
    public KakaoPayAccount() {}

	public KakaoPayAccount(String aid, String tid, String cid, String sid, String partner_order_id,
			String partner_user_id, String payment_method_type, Amount amount, Card card_info, String item_name,
	...
	public void setCard_info(Card card_info) {
		this.card_info = card_info;
	}
